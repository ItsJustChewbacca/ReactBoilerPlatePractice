...
const makeFeaturedEventsSelector = () => createSelector(selectMainPageDomain, substate => substate.get('featuredEvents'))

const makeEventsSelector = () => createSelector(selectMainPageDomain, substate => substate.get('events'))
